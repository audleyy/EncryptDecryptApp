...
void RunShamirTests() {
    ...
    CheckTest(fileKey.primeValue == key.primeValue && fileKey.caValue == key.caValue && fileKey.cbValue == key.cbValue && fileKey.daValue == key.daValue && fileKey.dbValue == key.dbValue, "Shamir key file");
}
